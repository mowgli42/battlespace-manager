#!/usr/bin/env python3
"""Verify entity-display feature harness — fog zones, routes, route-target alerts."""
...
def verify_local() -> dict:
    ...
    checks = verify_entity_features(snapshot)
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Verify entity-display feature harness")
    ...
    if args.json:
        ...
        print(f"\nEntity display feature harness: {status}")
